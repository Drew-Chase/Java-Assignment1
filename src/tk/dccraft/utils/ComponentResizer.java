...
public class ComponentResizer extends MouseAdapter {
	...
	/**
	 * Convenience constructor. Eligible borders are resisable in increments of a
	 * single pixel. Components can be registered when the class is created or
	 * they can be registered separately afterwards.
	 *
	 * @param dragInsets
	 ...
	 *
	 * @param dragInsets
	 *            Insets to control which borders are resizable.
	 */
	 ...
	 *
	 * @param snapSize
	 *            Dimension object allows you to separately specify a horizontal
